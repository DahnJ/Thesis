...
\draw [line width=0.3pt,dotted,color=wrwrwr] (0.5,0.2886751345948128) circle (0.5773502691896257cm);
\begin{scriptsize}
...
\draw [line width=0.3pt,color=rvwvcq] (1,0)-- (0.5,0.8660254037844386);
\draw [line width=0.3pt,color=rvwvcq] (0.5,0.8660254037844386)-- (0,0);
\draw [line width=0.3pt,dash pattern=on 1pt off 1pt,color=ffqqtt] (0.4993733260025002,-0.3661748684203649) circle (0.9256483931469245cm);
\draw [line width=0.3pt,dash pattern=on 1pt off 1pt,color=ffqqtt] (0.5,0.28867513459481287) circle (0.27877050834391687cm);
\draw [line width=0.3pt,dash pattern=on 1pt off 1pt,color=ffqqtt] (0.5,0.28867513459481287) circle (0.8793764157193666cm);
\begin{scriptsize}
\draw [fill=rvwvcq] (0,0) circle (0.5pt);
\draw[color=rvwvcq] (0.020731175192614887,0.053989196036012065) node {$A$};
\draw [fill=rvwvcq] (1,0) circle (0.5pt);

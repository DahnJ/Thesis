...
This work, as a part of the project solution of GACR 17-00393J (investigator V. Bene\v{s}), studies a type of tessellations closely related to the grain structure of polycrystalline materials --- tetrahedrizations, in particular Gibbs-type tetrahedrizations\todoo{Add the fact that tetrahedrizations are used for method of finite elements}. These tessellations based on the Gibbs point process allow a great flexibility in modelling the different properties of the resulting structure. 
The main contribution of this text is twofold. 

% https://hal.archives-ouvertes.fr/hal-00858028

\todoo[inline]{Switch the paragraphs so it's chronological}

...
% Need to prove p''_\eta is bounded and need explicit bound for diam B(\eta)



% Radical hyperplane is a hyperplane
% Characteristic point is their intersection [by definition, basically]
% Changing a weight in a point translates the hyperplane
% Limited weight => Limited translation => Only care about general position

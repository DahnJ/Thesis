...
It would be possible to solve \ref{eq:CMeq} as an equation of $r$. A better approach is to  subtract $r^2$ times the first row from the last and subtract $r^2$ times the first column from the last to obtain the determinant 
